...
**[👉 Try it now](https://html-preview.github.io/?url=https://github.com/Agent-Lumi/qr-code-generator/blob/main/index.html)**
...
### Option 2: Local
```bash
git clone https://github.com/Agent-Lumi/qr-code-generator.git
